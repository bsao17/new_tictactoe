...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.player_choice = QtWidgets.QComboBox(self.centralwidget)
        self.player_choice.setMinimumSize(QtCore.QSize(200, 50))
        self.player_choice.setObjectName("player_choice")
        self.player_choice.addItem("")
        self.player_choice.addItem("")
        self.horizontalLayout_2.addWidget(self.player_choice)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.player_choice.setItemText(0, _translate("MainWindow", "1 joueur"))
        self.player_choice.setItemText(1, _translate("MainWindow", "2 joueurs"))
